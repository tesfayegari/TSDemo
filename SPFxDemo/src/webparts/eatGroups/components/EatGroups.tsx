...
import styles from "./EatGroups.module.scss";
import { IEatGroupsProps } from "./IEatGroupsProps";
import { IListItem } from "./IListItem";
import { IEatGroupsState } from "./IEatGroupsState";
import { SPHttpClient, SPHttpClientResponse } from "@microsoft/sp-http";

export default class EatGroups extends React.Component<
  IEatGroupsProps,
  IEatGroupsState
> {
  private listItemEntityTypeName: string = undefined;

  constructor(props: IEatGroupsProps) {
    super(props);
  ...
  public componentWillReceiveProps(nextProps: IEatGroupsProps): void {
  ...
  private listNotConfigured(props: IEatGroupsProps): boolean {
    return (
  ...
  public render(): React.ReactElement<IEatGroupsProps> {
  ...
  private updateItem(): void {
    ...
    this.getListItemEntityTypeName()
      .then(
        (listItemType: string): Promise<number> => {
      ...
      .then(
        (itemId: number): Promise<SPHttpClientResponse> => {
          ...
          return this.props.spHttpClient.get(
            `${this.props.siteUrl}/_api/web/lists/getbytitle('${this.props.listName}')/items(${latestItemId})?$select=Id`,
            SPHttpClient.configurations.v1,
            {
              headers: {
                Accept: "application/json;odata=nometadata",
